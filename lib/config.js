...
module.exports = {
    ...
    DB_URL: process.env.DB_URL || 'mongodb://localhost/maildb',
    PREHEATING_DB_URL: process.env.PREHEATING_DB_URL || 'mongodb://localhost/sampledb',
    MAILGUN: {
        apiKey: process.env.MAILGUN_API_KEY || 'your_api_key',
        domain: process.env.MAILGUN_DOMAIN || 'mg.example.com'
    },
    PDFGENERATOR_URI: process.env.PDFGENERATOR_URI ||'http://localhost:8082/pdfgenerator',
